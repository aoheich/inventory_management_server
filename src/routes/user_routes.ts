...
import { create_user, current_user, get_users, logout, refresh, user_delete, user_login } from "../controllers/user_controller.js";
...
user_router.post("/logout", async_handler(logout))
